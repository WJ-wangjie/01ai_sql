...
) aa where robot_time >= '2024-05-30 00:00:00' and   person_time<=  DATE_SUB(CURDATE(), INTERVAL 0 DAY) + INTERVAL 12 HOUR
       and biz_type in ('digital_human')
