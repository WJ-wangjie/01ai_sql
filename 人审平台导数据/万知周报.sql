...
) a left join (select * from merged_data where row_num=1) b   on a.message_id = b.id
) aa where robot_time >= '2024-05-29 00:00:00' and  robot_time <= '2024-06-05 00:00:00' -- and person_time<='2024-05-29 12:00:00'
       and robot_result!=person_result and biz_type='wanzhi' and  robot_result='unsafe' and person_result='safe'
