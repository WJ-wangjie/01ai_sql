...
) aa where robot_time >= DATE_SUB(CURDATE(), INTERVAL 2 DAY) + INTERVAL 0 HOUR and  robot_time <= DATE_SUB(CURDATE(), INTERVAL 1 DAY) + INTERVAL 24 HOUR  and  person_time>=  DATE_SUB(CURDATE(), INTERVAL 1 DAY) + INTERVAL 10 HOUR
       and biz_type='wanzhi'
